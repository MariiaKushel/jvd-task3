...
public abstract class Medicins {
	...
	public Medicins(String medicinsId, boolean outOfProdaction, String name, String pharm, GroupATC group,
	...
	public class Version {
		...
		private Medicins getEnclosingInstance() {
			return Medicins.this;
		}

		@Override
		public String toString() {
			return new StringBuilder().append("Medicins [medicinsId=").append(country).append(", certificate=")
					.append(certificate).append(", dataFrom=").append(dataFrom).append(", dataTo=").append(dataTo)
					.append(", pack=").append(pack).append(", dosage=").append(dosage).append("]").toString();
		}

	}

	public String getMedicinsId() {
		return medicinsId;
	}

	public void setMedicinsId(String medicinsId) {
		this.medicinsId = medicinsId;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((medicinsId == null) ? 0 : medicinsId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (medicinsId == null) {
			if (other.medicinsId != null) {
				return false;
			}
		} else if (!medicinsId.equals(other.medicinsId)) {
			return false;
		}
		if (name == null) {
			if (other.name != null) {
	...
	@Override
	public String toString() {
		return new StringBuilder().append("Medicins [medicinsId=").append(medicinsId).append(", outOfProdaction=")
				.append(outOfProdaction).append(", name=").append(name).append(", pharm=").append(pharm)
				.append(", group=").append(group).append(", analogs=").append(analogs).append(", version=")
